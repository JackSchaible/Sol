        ...
        private ModuleBlueprints[] Generate()
        {
            return new ModuleBlueprints[]
            {
                ...
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    25, 500, 25, new []{ new ConnectorPosition{ Position = ConnectorPositions.Backward }}, 1, 200, 1, 8),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    25, 550, 35, new []{ new ConnectorPosition { Position = ConnectorPositions.Backward }}, 1, 500, 1, 12),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    "Ships/Control Centres/Small Ship/Heavy Cockpit - Build", "Heavy Cockpit",
                    "A basic cockpit with a bit more space for 2 pilots.",
                    40, 750, 30, new []{ new ConnectorPosition { Position = ConnectorPositions.Backward} }, 2, 250, 2, 16),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    50, 800, 50, new []{ new ConnectorPosition { Position = ConnectorPositions.Backward }}, 2, 550, 2, 24),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    75, 1500, 100, new []{ new ConnectorPosition { Position = ConnectorPositions.Backward }}, 3, 1000, 3, 36),
                #endregion
                #endregion
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/LMG - Build",
                    "Light Machine Gun", "A lighter machine gun firing smaller rounds at a higher rate of fire. Does poorly against shields and armor, but the higher projectile speed means higher accuracy at longer ranges.",
                    200, 15, new []{new ConnectorPosition(ConnectorPositions.Down, true, null)},
