        ...
        private ModuleBlueprint[] Generate()
        {
            return new ModuleBlueprint[]
            {
                ...
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    25, 500, 25, false, new[] {new ConnectorPosition {Direction = ConnectorPositions.Backward}}, 1, 200, 1, 8),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    25, 550, 35, false, new[] {new ConnectorPosition {Direction = ConnectorPositions.Backward}}, 1, 500, 1,
                    12),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    40, 750, 30, false, new[] {new ConnectorPosition {Direction = ConnectorPositions.Backward}}, 2, 250, 2,
                    16),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    50, 800, 50, false, new[] {new ConnectorPosition {Direction = ConnectorPositions.Backward}}, 2, 550, 2,
                    24),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    75, 1500, 100,
                    false, new[] {new ConnectorPosition {Direction = ConnectorPositions.Backward, Position = IntVector.Right}},
                    3, 1000, 3, 36),
