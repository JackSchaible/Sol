        ...
        private static CockpitModuleBlueprint[] GetCockpits()
        {
            return new []
            {
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    "Ships/Control Centres/Small Ship/Basic Cockpit - Build", new []
                    {
                        Vector3Int.zero
                    },
                    "Basic Cockpit",
                ...
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    "Ships/Control Centres/Small Ship/Advanced Cockpit - Build", new [] {Vector3Int.zero},
                    "Advanced Cockpit",
                    ...
                    25, 550, new Cost(1, 3, 1, 2, 0), false, new [] {new Connector {Direction = ConnectorDirections.Backward}}, 1, 500,
                    1,
                    12),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    "Ships/Control Centres/Small Ship/Heavy Cockpit - Build", new [] {Vector3Int.zero},
                    "Heavy Cockpit",
                    "A basic cockpit with a bit more space for 2 pilots.",
                    40, 750, new Cost(1, 2, 1, 1, 0), false, new [] {new Connector {Direction = ConnectorDirections.Backward}}, 2, 250,
                    2,
                    16),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    50, 800, new Cost(1, 4, 1, 3, 0), false, new [] {new Connector {Direction = ConnectorDirections.Backward}}, 2, 550,
                    2,
                    24),
                new CockpitModuleBlueprint(ControlCentreTypes.SmallShip,
                    ...
                    false,
                    new [] {new Connector {Direction = ConnectorDirections.Backward, Position = Vector3Int.right}},
                    3, 1000, 3, 36)
            };
        }
        ...
        private static WeaponBlueprint[] GetProjectiles()
        {
            return new []
            {
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/LMG - Build",
                    ...
                    200, new Cost(0, 0, 0, 10, 0), false, new [] {new Connector {Direction = ConnectorDirections.Down}},
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/HMG - Build",
                    ...
                    400, new Cost(0, 0, 0, 58, 0), false, new [] {new Connector {Direction = ConnectorDirections.Down}},
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/Chain Gun - Build",
                    ...
                    750, new Cost(0, 0, 0, 112, 0), false, new [] {new Connector {Direction = ConnectorDirections.Forward}},
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/AA Gun - Build",
                    ...
                    {
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat}, Vector3Int.zero),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat}, Vector3Int.right),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat}, Vector3Int.up),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat}, new Vector3Int(1, 1, 0))
                    },
                    new []
                    {
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/HE Cannon - Build",
                    ...
                    1000, new Cost(0, 0, 1243, 6757, 0), false, new [] {new Connector {Direction = ConnectorDirections.Down}},
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/Incendiary Cannon - Build",
                    ...
                    1000, new Cost(0, 0, 3000, 7000, 0), false, new [] {new Connector {Direction = ConnectorDirections.Down}},
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/Tracer Gun - Build",
                    ...
                    1000, new Cost(0, 0.03f, 0, 320, 0), false, new [] {new Connector {Direction = ConnectorDirections.Forward}},
                ...
                new WeaponBlueprint(WeaponTypes.Projectile, "Ships/Weapons/Projectiles/Depleted-Uranium Slug Cannon - Build",
                    new []
                    {
                        new Vector3Int(0, 0, 0), new Vector3Int(0, 1, 0), new Vector3Int(0, 2, 0), new Vector3Int(0, 3, 0), new Vector3Int(0, 4, 0), new Vector3Int(0, 5, 0),
                        new Vector3Int(1, 0, 0), new Vector3Int(1, 1, 0), new Vector3Int(1, 2, 0), new Vector3Int(1, 3, 0), new Vector3Int(1, 4, 0), new Vector3Int(1, 5, 0),
                        new Vector3Int(2, 2, 0), new Vector3Int(2, 3, 0), new Vector3Int(2, 4, 0), new Vector3Int(2, 5, 0),
                        new Vector3Int(3, 2, 0), new Vector3Int(3, 3, 0),
                        new Vector3Int(4, 2, 0), new Vector3Int(4, 3, 0),
                        new Vector3Int(5, 2, 0), new Vector3Int(5, 3, 0),

                        new Vector3Int(0, 0, 1), new Vector3Int(0, 1, 1), new Vector3Int(0, 2, 1), new Vector3Int(0, 3, 1), new Vector3Int(0, 4, 1), new Vector3Int(0, 5, 1),
                        new Vector3Int(1, 0, 1), new Vector3Int(1, 1, 1), new Vector3Int(1, 2, 1), new Vector3Int(1, 3, 1), new Vector3Int(1, 4, 1), new Vector3Int(1, 5, 1),
                        new Vector3Int(2, 2, 1), new Vector3Int(2, 3, 1), new Vector3Int(2, 4, 1), new Vector3Int(2, 5, 1),
                        new Vector3Int(3, 2, 1), new Vector3Int(3, 3, 1),
                        new Vector3Int(4, 2, 1), new Vector3Int(4, 3, 1),
                    ...
                    {
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 0, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 1, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 2, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 3, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 4, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 5, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(1, 0, 0)),
                        new Connector(ConnectorDirections.Backward, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(1, 1, 0)),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 0, 0)),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 1, 0)),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 2, 0)),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 3, 0)),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 4, 0)),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air}, new Vector3Int(0, 5, 0)),
                    },
                    new []
                    {
        ...
        private static DecorativeModuleBlueprint[] GetDecorativeModules()
        {
            return new[]
            {
                new DecorativeModuleBlueprint("Ships/Miscellanious/Decorative/Panel - Build",
                    ...
                    {
                        new Connector(ConnectorDirections.Backward, new Materials[0]),
                        new Connector(ConnectorDirections.Left, new Materials[0]),
                        new Connector(ConnectorDirections.Down, new Materials[0]),
                        new Connector(ConnectorDirections.Forward, new Materials[0]),
                        new Connector(ConnectorDirections.Right, new Materials[0]),
                        new Connector(ConnectorDirections.Up, new Materials[0])
                    },
                    new ExclusionVector[] { }),
                ...
                new DecorativeModuleBlueprint("Ships/Miscellanious/Decorative/Weapon Mount - Build",
                    ...
                    {
                        new Connector(ConnectorDirections.Forward, new[] {Materials.Power}),
                        new Connector(ConnectorDirections.Up, new[] {Materials.Power}),
                        new Connector(ConnectorDirections.Down, new[] {Materials.Power})
                    },
                    new ExclusionVector[] { })
            };
        }
        private static HallwayModuleBlueprint[] GetHallwayModules()
        {
            return new []
            {
                ...
                new HallwayModuleBlueprint("Ships/Miscellanious/Hallways/EW Hallway - Build",
                    ...
                    {
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air, Materials.Water, Materials.Waste}),
                        new Connector(ConnectorDirections.Right, new []{Materials.Power, Materials.Heat, Materials.Air, Materials.Water, Materials.Waste}),
                        new Connector(ConnectorDirections.Up, new Materials[0]),
                        new Connector(ConnectorDirections.Down, new Materials[0]),
                        new Connector(ConnectorDirections.Forward, new Materials[0]),
                        new Connector(ConnectorDirections.Backward, new Materials[0]),
                ...
                new HallwayModuleBlueprint("Ships/Miscellanious/Hallways/NS Hallway - Build",
                    ...
                    0, 1000, new Cost(0, 1, 0, 1, 0), false, new []
                    {
                        new Connector(ConnectorDirections.Left, new Materials[0]),
                        new Connector(ConnectorDirections.Right, new Materials[0]),
                        new Connector(ConnectorDirections.Up,  new []{Materials.Power, Materials.Heat, Materials.Air, Materials.Water, Materials.Waste}),
                        new Connector(ConnectorDirections.Down,  new []{Materials.Power, Materials.Heat, Materials.Air, Materials.Water, Materials.Waste}),
                        new Connector(ConnectorDirections.Forward, new Materials[0]),
                        new Connector(ConnectorDirections.Backward, new Materials[0]),
                    },
                    new ExclusionVector[] { }),
                ...
                new HallwayModuleBlueprint("Ships/Miscellanious/Hallways/NE-SW Hallway - Build",
                    ...
                    0, 1000, new Cost(0, 1, 0, 1, 0), false, new []
                    {
                        ...
                        new Connector(ConnectorDirections.Forward, new Materials[0]),
                        new Connector(ConnectorDirections.Backward, new Materials[0]),
                        new Connector(ConnectorDirections.Right,  new []{Materials.Power, Materials.Heat, Materials.Air, Materials.Water, Materials.Waste}, Vector3Int.up),
                        new Connector(ConnectorDirections.Forward, new Materials[0], Vector3Int.up),
                        new Connector(ConnectorDirections.Backward, new Materials[0], Vector3Int.up),
                    },
                    new ExclusionVector[] { }),
                ...
                new HallwayModuleBlueprint("Ships/Miscellanious/Hallways/NW-SE Hallway - Build",
                    ...
                    0, 1000, new Cost(0, 1, 0, 1, 0), false, new []
                    {
                        ...
                        new Connector(ConnectorDirections.Forward, new Materials[0]),
                        new Connector(ConnectorDirections.Backward, new Materials[0]),
                        new Connector(ConnectorDirections.Left, new []{Materials.Power, Materials.Heat, Materials.Air, Materials.Water, Materials.Waste}, Vector3Int.up),
                        new Connector(ConnectorDirections.Forward, new Materials[0], Vector3Int.up),
                        new Connector(ConnectorDirections.Backward, new Materials[0], Vector3Int.up),
                    },
                    new ExclusionVector[] { }),
