namespace Assets.Ships
{
    public class CommandModuleStats : ModuleStats
    {
        ...
        public CommandModuleStats(string moduleType, string buildSprite, string name, string description, int width, int height, 
            ...
            : base(ModuleTypes.ControlCentre, moduleType, buildSprite, name, description, width, height, offsetX, offsetY, 
                  originx, originY, health, armor, weight, cost, crewRequirement, powerConumption, 0)
        {
